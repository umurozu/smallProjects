...
public class PaintBrush extends JFrame implements MouseInputListener,ActionListener {
	...
	public void paint(Graphics g) {
		...
		for(int i = 0; i < shape.size();i++) {
			...
			if(shape.get(i).getClass().getName().equals("PaintBrush$Point")) {
			...
			else if(shape.get(i).getClass().getName().equals("PaintBrush$Rectangle")) {
		...
		if(drawoval && inborder) {
			...
			if(moveshape) {
				...
				for(int i = 0; i < shape.size(); i++) {
					...
					if(shape.get(i).getClass().getName().equals("PaintBrush$Rectangle")) {
					...
					else if(shape.get(i).getClass().getName().equals("PaintBrush$Oval")) {
	...
	public void mouseReleased(MouseEvent e) {
		...
		if(moveshape && withinshape) {
			...
			if(shape.get(item).getClass().getName().equals("PaintBrush$Rectangle")) {
			...
			else if (shape.get(item).getClass().getName().equals("PaintBrush$Oval")) {
